                    ...
                    columns: [
                        ...
                        {data:'nim', render: function(data) {
                            return '<div class="d-flex justify-content-center m-2">'+
                                        '<button type="button" class="btn btn-warning btn-sm" id="editMahasiswa" data-bs-toggle="modal" data-target="#modal-mahasiswa" data-nim="'+data+'">Edit</button>'+
                                        '<button type="button" class="btn btn-danger btn-sm" id="hapusModal" data-bs-toggle="modal" data-target="#hapusMahasiswa" data-nim="'+data+'">Hapus</button>'+
                                    '</div>';
                        }},
                    ]
                });
